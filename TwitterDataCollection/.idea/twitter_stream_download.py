...
def get_parser():
    ...
    parser.add_argument("-q",
                        ...
                        dest="query",
                        help="Query/Filter",
                        #you add your query term here
                        #for different separate words use """" and """"
                        default='dublin')
...
class MyListener(StreamListener):
    ...
    def __init__(self, data_dir, query):
        ...
        self.outfile = "%s/stream_%s.json" % ("C:\\Users\\piush\\Desktop\\Programming\\Python\\PythonExcercises\\TwitterDataCollection", query_fname)
